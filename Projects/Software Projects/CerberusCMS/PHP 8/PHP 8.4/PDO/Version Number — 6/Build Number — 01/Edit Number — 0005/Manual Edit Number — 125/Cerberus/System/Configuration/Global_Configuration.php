...
$_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MySQL_PDO		= "./System/Configuration/Global_SQL_Server_Database_Class_MySQL_PDO.php";
$_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL		= "./System/Configuration/Global_SQL_Server_Database_Class_MicrosoftSQL_Standard.php";
$_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL_PDO	= "./System/Configuration/Global_SQL_Server_Database_Class_MicrosoftSQL_Standard.php";
...
if (file_exists($_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL)) {

	include_once "$_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL";

} else {

	echo ("Kernel Message: Error, Missing File :: Database Management System Server Database :: Class File: $_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL");
...
/*
 ============================================================================================================
 + IF: Global S.Q.L. Database Management System Server Database :: Settings :: Is: PDO :: MySQL :: Standard
 ============================================================================================================
*/
...
if (file_exists($_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MySQL_PDO)) {

	include_once "$_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MySQL_PDO";

} else {

	echo ("Kernel Message: Error, Missing File :: Database Management System Server Database :: Class File: $_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MySQL_PDO");

} // [ + ] IF: File Exists: Database Management System Server Database: Class File

} // [ + ] IF: Structured-Database-Server-Query Database Management System Server Engine :: Settings :: Is: PDO :: MySQL :: Standard

/*
 ============================================================================================================
 + IF: Global S.Q.L. Database Management System Server Database :: Settings :: Is: PDO :: MicrosoftSQL :: Standard
 ============================================================================================================
*/

if ($_ACCESS_SQL_ENGINE_VERSION == "6") {
...
if (file_exists($_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL_PDO)) {

	include_once "$_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL_PDO";

} else {

	echo ("Kernel Message: Error, Missing File :: Database Management System Server Database :: Class File: $_GLOBAL_SQL_SERVER_DATABASE_CLASS_FILE_STANDARD_MicrosoftSQL_PDO");

} // [ + ] IF: File Exists: Database Management System Server Database: Class File

} // [ + ] IF: Structured-Database-Server-Query Database Management System Server Engine :: Settings :: Is: PDO :: MicrosoftSQL :: Standard
