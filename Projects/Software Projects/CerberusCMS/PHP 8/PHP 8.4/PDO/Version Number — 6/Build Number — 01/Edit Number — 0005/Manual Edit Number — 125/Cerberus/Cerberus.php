...
/*
 ============================================================================================================
 + Global :: System :: S.Q.L. Settings: Plug-Ins :: Sensors
 ============================================================================================================
*/

$_GLOBAL_SYSTEM_PLUGIN_DIRECTORY_SENSORS						= $_DB_Query_Kernel_Select_System_Settings_Fetch_Array['settings_system_plugin_directory_sensors'];
$_GLOBAL_SYSTEM_PLUGIN_STATUS_SENSORS							= $_DB_Query_Kernel_Select_System_Settings_Fetch_Array['settings_system_plugin_status_sensors'];
...
/*
 ============================================================================================================
 + Global :: System :: S.Q.L. Settings: Plug-Ins :: Watermark
 ============================================================================================================
*/

$_GLOBAL_SYSTEM_PLUGIN_DIRECTORY_WATERMARK						= $_DB_Query_Kernel_Select_System_Settings_Fetch_Array['settings_system_plugin_directory_watermark'];
$_GLOBAL_SYSTEM_PLUGIN_STATUS_WATERMARK							= $_DB_Query_Kernel_Select_System_Settings_Fetch_Array['settings_system_plugin_status_watermark'];
...
$_GLOBAL_SYSTEM_UPLOAD_SIZE_PRIVATE_MEMBER_MESSENGER					= $_DB_Query_Kernel_Select_System_Settings_Fetch_Array['settings_system_upload_size_private_member_messenger'];
...
/*
 ============================================================================================================
 +
 + System :: Plug-In :: Sensors :: Directives
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + IF: The Sensors Plug-In Is On, Include It
 ============================================================================================================
*/

if ($_GLOBAL_SYSTEM_PLUGIN_STATUS_SENSORS >= 1) {

	include_once "./System/Plug-Ins/Sensors/$_GLOBAL_SYSTEM_PLUGIN_DIRECTORY_SENSORS/Sensors.$_INTERNAL_FILE_EXTENSION";

/*
 ============================================================================================================
 + ELSE: The Sensors Plug-In Is Off, Print Message
 ============================================================================================================
*/

} else {

	$_GLOBAL_SYSTEM_PLUGIN_SENSORS_MESSAGE_DEACTIVATED				= "<CENTER>Kernel Message: The Location Plug-In Application Module Is: De-Activated</CENTER>";

} // [ + ] IF: System :: Plug-In :: Sensors :: Is: On or Off

/*
 ============================================================================================================
 +
 + System :: Plug-In :: Watermark :: Directives
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + IF: The Watermark Plug-In Is On, Include It
 ============================================================================================================
*/

if ($_GLOBAL_SYSTEM_PLUGIN_STATUS_WATERMARK >= 1) {

	include_once "./System/Plug-Ins/Watermark/$_GLOBAL_SYSTEM_PLUGIN_DIRECTORY_WATERMARK/Location.$_INTERNAL_FILE_EXTENSION";
...
*/
	...
	$_GLOBAL_SYSTEM_PLUGIN_WATERMARK_MESSAGE_DEACTIVATED				= "<CENTER>Kernel Message: The Watermark Plug-In Application Module Is: De-Activated</CENTER>";

} // [ + ] IF: System :: Plug-In :: Watermark :: Is: On or Off
