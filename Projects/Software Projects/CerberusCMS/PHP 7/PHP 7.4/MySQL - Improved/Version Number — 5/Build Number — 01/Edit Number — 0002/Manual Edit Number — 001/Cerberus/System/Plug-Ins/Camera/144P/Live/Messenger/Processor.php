...
$_Application_Module_Member_Messenger_SQL_LIST_MESSENGER_CLEAR_TEXT_FILE_MESSENGER_ROOM_NAME	= $_Application_Module_Member_Messenger_DB_Query_RETRIEVE_ALL_VISIBLE_CLEAR_TEXT_FILE_MESSENGER_ROOM_NAMES_ARRAY['messenger_room_name'];
...
move_uploaded_file($_FILES['blobFile']['tmp_name'], "../../../../../../Temporary/Messenger/Upload/$_GLOBAL_LOCAL_SERVER_DATE_STANDARD.mp4");
...
copy("../../../../../../Temporary/Messenger/Upload/$_GLOBAL_LOCAL_SERVER_DATE_STANDARD.mp4","../../../../../../Temporary/Messenger/Text-File/Clear-Text/Visible/$_Application_Module_Member_Messenger_SQL_LIST_MESSENGER_CLEAR_TEXT_FILE_MESSENGER_ROOM_NAME/Files/Video/Live Video - $_GLOBAL_LOCAL_SERVER_DATE_STANDARD.mp4");
?>